...
class signUpLogInfo extends StatefulWidget {
  const signUpLogInfo({super.key});
  @override
  State<signUpLogInfo> createState() => _signUpLogInfoState();
}

class _signUpLogInfoState extends State<signUpLogInfo> {
  final _form = GlobalKey<FormState>();
  var _username = '';
  var _password = '';
  var _comfirmedPassword = '';
  void _submit() async {
    print('submit');
